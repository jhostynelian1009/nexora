...
def seed_data(db: Session) -> None:
    ...
    print("[Seeder] Seeding demo data for Nexora...")
    ...
    posts_data = [
        {
            "author": ana,
            "content": "¡Bienvenidos a Nexora! 🚀 Presentamos nuestra nueva plataforma académica de intercambio y colaboración construida con React + FastAPI.",
            "image_url": "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&auto=format&fit=crop&q=80"
        },
        {
            "author": carlos,
            "content": "Acabo de terminar el diseño responsive para el feed de Nexora. El tema oscuro con HSL y Lucide React quedó espectacular. 🎨",
            "image_url": "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&auto=format&fit=crop&q=80"
        },
        {
            "author": elena,
            "content": "Analizando la integridad de datos con SQLAlchemy 2.0 y MySQL 8. La relación entre usuarios, publicaciones, comentarios y likes funciona de forma óptima. 📊",
            "image_url": None
        },
        {
            "author": mateo,
            "content": "Implementada la autenticación stateless con JWT Bearer y hashing bcrypt adaptativo. Seguridad reforzada para el MVP. 🔐",
            "image_url": None
        }
    ]
    ...
    # Seed Comments
    comments_data = [
        (carlos.id, p1.id, "Excelente trabajo equipo. ¡La arquitectura es muy limpia!"),
        (elena.id, p1.id, "Felicidades, la integración entre React y FastAPI es genial."),
        (ana.id, p2.id, "¡El diseño oscuro se ve súper moderno y fluído!"),
        (mateo.id, p3.id, "Gran aporte Elena, las consultas e2e responden en menos de 100ms."),
        (carlos.id, p4.id, "Muy importante tener contraseñas seguras con bcrypt."),
    ]
    ...
    print("[Seeder] Seed process successfully completed!")
